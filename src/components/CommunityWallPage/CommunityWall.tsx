...
const cardsData = [
  {
    message: "Hi there! A friend on discord shared this with me. Such a cool idea!",
...
const CommunityWall = () => {
  return (
    <div className="w-full min-h-screen flex justify-center items-start py-20 px-10 bg-[#f4f4f4]">
            ...
            <div key={index} className={`relative w-[250px] h-[300px]`}>
              ...
              >
                ...
                >
                  ...
                  <p className="text-[16px] text-center text-white font-bold drop-shadow">
                    {card.message}
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-[32px] h-[32px] rounded-full bg-black flex items-center justify-center text-white font-bold">
                    {card.user.charAt(0)}
                  </div>
